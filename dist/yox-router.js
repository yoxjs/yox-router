(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("YoxRouter", [], factory);
	else if(typeof exports === 'object')
		exports["YoxRouter"] = factory();
	else
		root["YoxRouter"] = factory();
})(this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	var parentHotUpdateCallback = this["webpackHotUpdateYoxRouter"];
/******/ 	this["webpackHotUpdateYoxRouter"] = function webpackHotUpdateCallback(chunkId, moreModules) { // eslint-disable-line no-unused-vars
...
/***/ function(module, exports) {
	...
	function parseQuery(query) {
	  ...
	  if (utils.is.string(query) && query.indexOf('=') >= 0) {
	    utils.array.each(query.split('&'), function (item) {
	...
	function parseParams(realpath, path) {
	  ...
	  var terms = realpath.split(DIVIDER);
	  utils.array.each(path.split(DIVIDER), function (item, index) {
	    if (item.startsWith(':')) {
	...
	function getPath(realpath) {
	  ...
	  var terms = realpath.split(DIVIDER);
	  utils.object.each(path2Config, function (config, path) {
	    var patterns = path.split(DIVIDER);
	...
	function stringifyHash(path, params, query) {
	  ...
	  utils.array.each(path.split(DIVIDER), function (term) {
	    realpath.push(term.startsWith(':') ? params[term.slice(1)] : term);
	  });

	  var hash = realpath.join(DIVIDER);
	...
	function onHashChange() {
	  var data = parseHash(location.hash.slice(1));
	  if (data) {
	    var name = path2Config[data.path].name;
